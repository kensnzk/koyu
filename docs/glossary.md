...
| language version, 言語版 | `muro 1.4` — the version of the semantics of the notation, written once in the base layer. **Omitted, the file is read as `1.1` — and always will be.** The word is `muro` from 1.2 and `koyu` at 1.1 and earlier | [version](reference/muro/version.md) |
