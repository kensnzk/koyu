...
| **validation** | architectural judgement under a profile you name | grows | may be messy | does not freeze |
...
- **structural diagnostics** — the codes in the diagnostic ledger that `check` returns
