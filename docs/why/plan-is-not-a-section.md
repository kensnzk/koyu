...
**この高さは導出の入力であって、導出が決めることではない。**切断高さを変えれば、腰窓が切れたり切れなかったりする。**同じ切断高さを与えれば、同じ平面が出る** — [同じ原本からは同じ形が出なければならない](form-must-be-unique.md) の約束は、この入力を固定した上での約束である。
...
四つを「各自が発明する」に任せれば、消費者ごとに違う平面図が出る。それは [形が一意でなければならない](form-must-be-unique.md) に反する。
