...
| 例 | 規模 | 初めて示すもの |
|---|---|---|
| [two-rooms](#examplestwo-roomsmuro) | 22行 / 空間3 / 境界3 / 32.40㎡ | 空間・境界・扉・外部。記法の最小単位 |
...
| [mansion](#examplesmansionmuro) | 187行 / 122 / 332 / 2366.40㎡ | 基準階のスパン展開・stack・粒度の混在 |
| [tower](#examplestower) | 438行9ファイル / 178 / 542 / 4785.92㎡ | 敷地形状 polygon・例外階の差分レイヤー・複数道路 |
...
438行9ファイル / 空間178 / 境界542 / 4785.92㎡。11階建ての複合ビル (低層商業+高層住宅)、角地・非矩形敷地。この記法のショーケースであり、分担して書かれたレイヤーが一棟としてビルドされる例である。
...
同じ物差しで [tower](#examplestower) を測ると、**原本9ファイル合計で432行・8,099トークン** — 延床4,786㎡・178空間・542境界の11階建てが、どのLLMのコンテキストにも収まる。
