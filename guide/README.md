...
| [howto/](howto/README.md) | 目的から引く手順書 8編 — 階を足す・間取りに割る・採光・扉と避難・敷地と容積率・ファイル分割・MCP接続・詰まったとき | 手が止まった人 |
| [diagnostics.md](diagnostics.md) | 診断コード全49件を**原因**と**直し方**と最小の再現つきで。エラー文から引く | `check` に叱られた人 |
