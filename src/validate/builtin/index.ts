...
import { ENVELOPE_ANALYSIS, ENVELOPE_ANALYSIS_ID, ENVELOPE_GAP_RULE } from "./envelope.js";
import {
  SITE_ANALYSIS,
  SITE_ANALYSIS_ID,
  SITE_AREA_RULE,
...
/**
 * The six analyses, in the order they are declared in the catalog.
 *
...
/**
 * The sixteen rules, in the order of the legacy ledger.
 *
