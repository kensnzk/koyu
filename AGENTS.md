...
6. **A change to the semantics of the language raises the language version** ([docs/reference/muro/version.md](docs/reference/muro/version.md)). The current one is `koyu 1.1`. What counts as meaning-preserving is defined by [docs/reference/stability.md](docs/reference/stability.md). Write the migration in an ADR and bring the examples up to the newest version.
