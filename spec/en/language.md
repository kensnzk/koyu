...
The norm for the notation as of koyu v0.11.0. For semantics (derivation, checking, queries) see [semantics.md](semantics.md); for the attribute contract see [vocabulary.md](vocabulary.md).
